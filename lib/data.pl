...
$toLatinData =
{
    ...
    Malayalam =>
    {
        INCONSONANTS => Set::IntSpan->new(hex('0d15') . '-' . hex('0d3a')),
        INPLOSIVES   => Set::IntSpan->new(hex('0d15') . ',' .
                                          hex('0d17') . ',' .
                                          hex('0d1a') . ',' .
                                          hex('0d1c') . ',' .
                                          hex('0d1f') . ',' .
                                          ...
                                          hex('0d2a') . ',' .
                                          hex('0d2c')),
        INVOWELMARKS => Set::IntSpan->new(hex('0d3e') . '-' . hex('0d4d') . ',' .
                                          hex('0d62') . '-' . hex('0d63')),
        INVOWELS     => Set::IntSpan->new(hex('0d05') . '-' . hex('0d14') . ',' .
                                          hex('0d60') . '-' . hex('0d61')),
        INMODIFIERS  => Set::IntSpan->new(hex('0d00') . '-' . hex('0d03')),
        INMISC       => Set::IntSpan->new(hex('0d66') . '-' . hex('0d78')),
        CHARMAP => {
            'അ','a','ആ','ā',
            'ഇ','i','ഈ','ī',
            'ഉ','u','ഊ','ū',
            ...
            'ം','ṁ',
            'ഃ','ḥ',
            'ക','k','ഖ','kh','ഗ','g','ഘ','gh','ങ','ṅ',
            'ച','c','ഛ','ch','ജ','j','ഝ','jh','ഞ','ñ',
            'ട','ṭ','ഠ','ṭh','ഡ','ḍ','ഢ','ḍh','ണ','ṇ',
            'റ','ṯ','ഩ','ṉ',
            'ത','t','ഥ','th','ദ','d','ധ','dh','ന','n',
            'പ','p','ഫ','ph','ബ','b','ഭ','bh','മ','m',
            'യ','y','ര','r','ല','l','ള','ḷ','ഴ','ṛ','വ','v',
            'ശ','ś','ഷ','ṣ','സ','s','ഹ','h',
            'ാ','ā',
            'ി','i','ീ','ī',
            'ു','u','ൂ','ū',
